...
This installs dependencies with `uv sync`, generates systemd user services from templates, enables them, and starts monitoring their status. The services are set to auto-start on boot.
